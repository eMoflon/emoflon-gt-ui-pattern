...
/**
 * 
 * The AbstractSemanticHighlightingCalculator evaluates the {@link AbstractHighlightingRule} and activate the highlighting rule which fits.
 * For Implementation an Injection has to be implemented with a GrammarAccess. The GrammaAccess will be generated by Xtext for the DSL.
 * 
 * <h1> Example: </h1> <i>For a SemanticHighlightingCalculator</i><p>
 * <pre>
